...
export default function ListingItem({listing}) {
  return (<div className = 'bg-white shadow-md hover:shadow-lg transition-shadow overflow-hidden rounded-lg w-full sm:w-[330px]'>
    <Link to = {`listing/${listing._id}`}>
      <img src = {listing.imageUrls[0] || 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRn9Tv99eAnNT3dO9WJAiaIZ93RdDf6nAWiBw&s'}
      alt = 'listing cover'
      className = 'h-[320px] sm:h-[220px] object-cover hover:scale-105 transition-scale duration-300'/>
      <div className="p-3 flex flex-col gap-2 w-full">
        <p className = 'trucate text-lg font-semibold text-slate-700'>{listing.name}</p>
